...
public class InventoryTable
    ...
    private static final DecimalFormat skuFormat = new DecimalFormat("00000000"); // 8 digit
    private static final DecimalFormat locationFormat  = new DecimalFormat( "000000");    // 6 digit
...
//    }
    ...
    public synchronized Inventory readFromDatabase(String skuKey, String location) {
        ...
        try {
            ...
            if (rs == null) {
                log.warning("AccountTable.readFromDatabase(): Null resultSet trying to read SKU " + skuKey + " Locn " + location);
                return null;
            }
            while (rs.next()) {
